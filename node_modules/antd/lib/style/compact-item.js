...
function compactItemBorder(token, options) {
  ...
  return {
    ...
    '&-item': (0, _extends4["default"])((0, _extends4["default"])((0, _defineProperty2["default"])({}, hoverEffects, {
      zIndex: 2
    }), options.focusElCls ? (0, _defineProperty2["default"])({}, "&" + options.focusElCls, {
      zIndex: 2
...
function genCompactItemStyle(token, prefixCls) {
  ...
  return {
    '&-compact': (0, _extends4["default"])((0, _extends4["default"])({}, compactItemBorder(token, options)), compactItemBorderRadius(prefixCls, options))
  };
}